...
/**
 * A callable task that is used to fetch the details for a specific VT library
 * ETD URL.
 *
 * @author Michael Irwin
 */
public class IndividualVtechEtdTask implements Callable<Etd> {

  @Inject
  private PageFetcher pageFetcher;
  
  @Inject
  private VtechEtdExtractor etdExtractor;
  ...
  public Etd call() throws Exception {
    ...
    try {
      return etdExtractor.extractEtd(pageBody);
    } catch (Exception e) {
      throw new RuntimeException("Error extracting: " + url, e);
    }
  }
